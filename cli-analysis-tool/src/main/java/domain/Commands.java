...
public enum Commands {
  ...
  HELP_YEARLY_TOTAL ("help_yearly_total", "Please provide a year and the tool will generate a report for all months indicating totals for exports and imports for each month.\n"),
